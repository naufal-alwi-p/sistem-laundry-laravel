        ...
        <div class="card">
            <div class="card-body overflow-x-auto">
                ...
                @forelse ($pesanan_aktif as $pesanan)
                    @if ($loop->last)
                        <a class="row self-w-600 d-flex border border-3 border-dark rounded-pill py-3 text-decoration-none text-black self-hover-btn" href="/admin/user-detail-pesanan/{{ $pesanan->id }}">
                    ...
                    @else
                        <a class="row self-w-600 d-flex border border-3 border-dark rounded-pill mb-3 py-3 text-decoration-none text-black self-hover-btn" href="/admin/user-detail-pesanan/{{ $pesanan->id }}">
                            <div class="col-4 text-center">{{ $pesanan->id }}</div>
                            <div class="col-3 text-center">{{ $pesanan->status }}</div>
                            <div class="col-2 text-center">{{ $pesanan->jumlah }}</div>
                            <div class="col-3 text-center">{{ $pesanan->jenisCucian->nama }}</div>
